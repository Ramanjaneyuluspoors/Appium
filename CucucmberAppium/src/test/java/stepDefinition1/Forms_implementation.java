...
public class Forms_implementation {
	...
	public void user_click_on_the_specified_form(String form) {
	...
	public void user_click_on_the_given_formname(String form) {
	...
	public void click_save_and_new() throws InterruptedException {
		Forms_basic.form_Save_And_New();
	}

	@Then("Discard the form and navigate back to home")
	public void Discard_the_form_and_navigate_back_to_home() throws InterruptedException, MalformedURLException {
	...
	public void user_click_on_the_form_available_in_the_forms(String form) {
		user_click_on_the_specified_form(form);
	}

	@Then("user insert form data")
	public void user_insert_form_data() throws MalformedURLException, InterruptedException, ParseException {
		Forms_basic.verifyFormPagesAndFill();
	}
	...
	public void user_click_on_given_form(String form) {
		user_click_on_the_specified_form(form);
	}

	@Then("user enters Min value {int} and Max value {int}")
	public void user_enters_Min_value_and_Max_value(int min, int max)
	...
	public void user_click_on_given_form_name(String fieldDepency_form) {
	...
	public void user_gives_the_basecondition_and_dependencyfield_and_input_is(String baseCondition,
			String formFieldLabel, String formFieldInput) throws MalformedURLException, InterruptedException {
		FormAdvanceSettings.clickSectionInPages();
	...
	public void user_click_on_the_given_form(String regularExpression_form) {
	...
	public void user_enters_the_Regular_Expression_for_datatype(String regExp, String formFieldLabel)
			throws MalformedURLException, InterruptedException {
		FormAdvanceSettings.clickSectionInPages();
	...
	public void user_click_on_the_form_name(String colorForm) {
		user_click_on_the_specified_form(colorForm);
	}

	@Then("user enters the field value {int} for datatype {string}")
	public void user_enters_the_field_value_for_datatype(int fieldValue, String fieldLabel)
			throws MalformedURLException, InterruptedException {
		FormAdvanceSettings.clickSectionInPages();
	...
	public void user_click_on_the_form_given(String errorAndWarnMessageForm) {
		user_click_on_the_specified_form(errorAndWarnMessageForm);
	}

	@Then("user provide the condition {string} and gives input as {string}")
	public void user_provide_the_condition_and_gives_input_as(String errorCondition, String inputValue)
